...
//{ objsize, folio_size, objects_per_folio, folios_per_chunk, overhead_pages_per_chunk, magic: object_shift, folio_shift, object_multiply, folio_multiply},  // fragmentation(overhead bins net)
        {320,       20 *
                    Ki,        64,   100, 8,  41, 47, 6871947674lu, 6871947674lu},  //  21     0.784 ( 5 cache lines, 100 folios/chunk, at least 16448 bytes used/folio)
        {448,       28 *
                    Ki,        64,   72,  6,  41, 47, 4908534053lu, 4908534053lu},  //  22     0.705 ( 7 cache lines, 72 folios/chunk, at least 20544 bytes used/folio)
        {512,       4 *
                    Ki,        8,    472, 40, 9,  12, 1lu,          1lu},  //  23     0.863 ( 8 cache lines, 504 folios/chunk, at least 3592 bytes used/folio)
        {576,       36 *
                    Ki,        64,   56,  5,  42, 48, 7635497416lu, 7635497416lu},  //  24     0.767 ( 9 cache lines, 56 folios/chunk, at least 28736 bytes used/folio)
        {704,       44 *
                    Ki,        64,   46,  4,  42, 48, 6247225158lu, 6247225158lu},  //  25     0.792 (11 cache lines, 45 folios/chunk, at least 36928 bytes used/folio)
        {960,       60 *
                    Ki,        64,   33,  3,  42, 48, 4581298450lu, 4581298450lu},  //  26     0.710 (15 cache lines, 33 folios/chunk, at least 45120 bytes used/folio)
        {1024,      4 *
                    Ki,        4,    472, 40, 10, 12, 1lu,          1lu},  //  27     0.924 (16 cache lines, 504 folios/chunk, at least 3844 bytes used/folio)
        {1216,      76 *
                    Ki,        64,   26,  3,  43, 49, 7233629131lu, 7233629131lu},  //  28     0.763 (19 cache lines, 26 folios/chunk, at least 61504 bytes used/folio)
        {1472,      92 *
                    Ki,        64,   22,  2,  43, 49, 5975606673lu, 5975606673lu},  //  29     0.780 (23 cache lines, 21 folios/chunk, at least 77888 bytes used/folio)
        {1984,      124 *
                    Ki,        64,   16,  2,  43, 49, 4433514629lu, 4433514629lu},  //  30     0.719 (31 cache lines, 16 folios/chunk, at least 94272 bytes used/folio)
        {2 * Ki,    4 *
                    Ki,        2,    472, 40, 11, 12, 1lu,          1lu},  //  31     0.954 (32 cache lines, 504 folios/chunk, at least 3970 bytes used/folio)
        {2752,      172 *
                    Ki,        64,   11,  1,  44, 50, 6392509464lu, 6392509464lu},  //  32     0.666 (43 cache lines, 11 folios/chunk, at least 127040 bytes used/folio)
        {3904,      244 *
                    Ki,        64,   8,   1,  44, 50, 4506195196lu, 4506195196lu},  //  33     0.672 (61 cache lines, 8 folios/chunk, at least 176192 bytes used/folio)
        {4 * Ki,    4 *
                    Ki,        1,    472, 40, 12, 12, 1lu,          1lu},  //  34     0.938 (64 cache lines, 504 folios/chunk, at least 3905 bytes used/folio)
        {5312,      332 *
                    Ki,        64,   6,   1,  45, 51, 6623564023lu, 6623564023lu},  //  35     0.715 (83 cache lines, 6 folios/chunk, at least 249920 bytes used/folio)
        {7232,      452 *
                    Ki,        64,   4,   1,  45, 51, 4865095699lu, 4865095699lu},  //  36     0.649 (113 cache lines, 4 folios/chunk, at least 340032 bytes used/folio)
        {8 * Ki,    8 *
                    Ki,        1,    246, 20, 13, 13, 1lu,          1lu},  //  37     0.869 (128 cache lines, 252 folios/chunk, at least 7233 bytes used/folio)
        {10048,     628 *
                    Ki,        64,   3,   1,  46, 52, 7003258776lu, 7003258776lu},  //  38     0.662 (157 cache lines, 3 folios/chunk, at least 462912 bytes used/folio)
        {14272,     892 *
                    Ki,        64,   2,   1,  46, 52, 4930545417lu, 4930545417lu},  //  39     0.613 (223 cache lines, 2 folios/chunk, at least 643136 bytes used/folio)
...
//   for the larger stuff, we reduce the size of the object slightly which introduces some other fragmentation
        ...
        {252 * Ki,  252 *
                    Ki,        1,    8,   1,  50, 50, 4363141381lu, 4363141381lu},  //  44  (reserve a page for the list of sizes)
        {508 * Ki,  508 *
                    Ki,        1,    4,   1,  51, 51, 4328785937lu, 4328785937lu},  //  45  (reserve a page for the list of sizes)
        {1020 * Ki, 1020 *
                    Ki,        1,    2,   1,  52, 52, 4311810306lu, 4311810306lu},  //  46  (reserve a page for the list of sizes)

...
inline node_t<skey_t, sval_t> *
intlf<skey_t, sval_t, RecMgr>::newLeafNode(tArgs<skey_t, sval_t> *t, skey_t key, sval_t value) {
    auto result = recmgr->template allocate<node_t<skey_t, sval_t>>(t->tid);
    if (((uint64_t) result) & ADDRESS_MASK) setbench_error(
            "node address has invalid alignment for this tree---node address must be a multiple of 16 (this data structure implicitly assumes an allocator that gives you nodes with this alignment)");
...
template<typename skey_t, typename sval_t, class RecMgr>
void intlf<skey_t, sval_t, RecMgr>::populateEdge(struct edge<skey_t, sval_t> *e, node_t<skey_t, sval_t> *parent,
                                                 node_t<skey_t, sval_t> *child, int which) {
    e->parent = parent;
    e->child = child;
    e->which = which;
}
...
template<typename skey_t, typename sval_t, class RecMgr>
void intlf<skey_t, sval_t, RecMgr>::initializeTypeAndUpdateMode(tArgs<skey_t, sval_t> *t,
                                                                stateRecord<skey_t, sval_t> *state) {
...
template<typename skey_t, typename sval_t, class RecMgr>
bool
intlf<skey_t, sval_t, RecMgr>::markChildEdge(tArgs<skey_t, sval_t> *t, stateRecord<skey_t, sval_t> *state, bool which) {
    node_t<skey_t, sval_t> *node;
...
template<typename skey_t, typename sval_t, class RecMgr>
void intlf<skey_t, sval_t, RecMgr>::findSmallest(tArgs<skey_t, sval_t> *t, node_t<skey_t, sval_t> *node,
...
template<typename skey_t, typename sval_t, class RecMgr>
void intlf<skey_t, sval_t, RecMgr>::helpTargetNode(tArgs<skey_t, sval_t> *t, struct edge<skey_t, sval_t> *helpeeEdge,
                                                   int depth) {
...
template<typename skey_t, typename sval_t, class RecMgr>
void intlf<skey_t, sval_t, RecMgr>::helpSuccessorNode(tArgs<skey_t, sval_t> *t, struct edge<skey_t, sval_t> *helpeeEdge,
                                                      int depth) {
    node_t<skey_t, sval_t> *parent;
    node_t<skey_t, sval_t> *node;
    node_t<skey_t, sval_t> *left;

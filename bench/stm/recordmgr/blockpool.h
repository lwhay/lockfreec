...
public:
    ...
    ~blockpool() {
        ...
        VERBOSE DEBUG
        std::cout << " blocks allocated " << debugAllocated << " pool-allocated " << debugPoolAllocated << " freed "
                  << debugFreed << " pool-deallocated " << debugPoolDeallocated << std::endl;
    }

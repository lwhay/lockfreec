//
// Created by Michael on 2019-03-01.
//

#include <mm_malloc.h>
#include "bench/misc/global.h"
#include "table.h"
#include "catalog.h"
#include "row.h"
#include "txn.h"
...
#elif CC_ALG == MVCC
    manager = (Row_mvcc *) _mm_malloc(sizeof(Row_mvcc), ALIGNMENT);
#elif CC_ALG == HEKATON
    manager = (Row_hekaton *) _mm_malloc(sizeof(Row_hekaton), ALIGNMENT);
#elif CC_ALG == OCC
    manager = (Row_occ *) mem_allocator.alloc(sizeof(Row_occ), _part_id);
#elif CC_ALG == TICTOC
    manager = (Row_tictoc *) _mm_malloc(sizeof(Row_tictoc), ALIGNMENT);
#elif CC_ALG == SILO
    manager = (Row_silo *) _mm_malloc(sizeof(Row_silo), ALIGNMENT);
#elif CC_ALG == VLL
...
//		endtime = get_sys_clock(); // TODO: expensive?????????????

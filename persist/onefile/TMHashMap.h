...
// The PM lockfree basis comes from https://github.com/pramalhe/OneFile for comparison purposes.
//

#ifndef LOCKFREEC_TMHASHMAP_H
#define LOCKFREEC_TMHASHMAP_H

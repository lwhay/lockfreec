//
// Created by Michael on 2019-04-27.
// The lockfree basis comes from https://github.com/pramalhe/OneFile for comparison purposes.
//

#ifndef LOCKFREEC_ONEFILEWF_H
#define LOCKFREEC_ONEFILEWF_H

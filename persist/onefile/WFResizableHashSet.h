...
#ifndef LOCKFREEC_WFRESIZABLEHASHSET_H
#define LOCKFREEC_WFRESIZABLEHASHSET_H
...
public:
    ...
    void rebuild() {
        ...
        ofwf::tmtype<Node *> *newbuckets = (ofwf::tmtype<Node *> *) ofwf::tmMalloc(
                newcapacity * sizeof(ofwf::tmtype<Node *>));
        ...
        ofwf::tmFree(buckets.pload());
        buckets = newbuckets;
        std::cout << "\trebuild " << capacity << " to " << newcapacity << " with " << tracer.getRunTime() << std::endl;
...
#endif //LOCKFREEC_WFRESIZABLEHASHSET_H
